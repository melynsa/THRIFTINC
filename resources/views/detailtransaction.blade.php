        ...
        <div class="card card-stepper" style="border-radius: 16px;">
          <div class="card-header p-4">
            <div class="d-flex justify-content-between align-items-center">
              <div>
                <p class="text-muted mb-2"> Shipping Information <span class="fw-bold text-body">J&T -1222528743</span></p>
                <p class="text-muted mb-0"> Address <span class="fw-bold text-body">Pantheon Street, Italy 00046</span> </p>
                <p class="text-muted mb-0"> Payment <span class="fw-bold text-body">Bank BCA</span> </p>
                <p class="text-muted mb-0"> Order date <span class="fw-bold text-body">04 October 2022</span> </p>
                <p class="text-muted mb-0"> Payment date <span class="fw-bold text-body">04 October 2022</span> </p>
                <p class="text-muted mb-0"> Delivery date <span class="fw-bold text-body">06 October 2022</span> </p>
          ...
          <div class="card-footer p-4">
            <div class="d-flex justify-content-between">
              <h5 class="fw-normal mb-0"><a href="/transcation" style="color: #CDBBA7">Back</a></h5>
