        ...
        <div class="container h-100">
            ...
            <div class="col">
                ...
                <div class="card-body p-4" style="background-color: white">
                    ...
                    <div class="col-md-2">
                        <img src="/img/model12.jpg" 
                        class="img-fluid" alt="Generic placeholder image">
                    </div>
                    <div class="col-md-2 d-flex justify-content-center">
                        <div>
                        <p class="small text-muted mb-4 pb-2">Name</p>
                        <p class="lead fw-normal mb-0">Crewneck Nike</p>
                        </div>
                    </div>
                    <!-- <div class="col-md-2 d-flex justify-content-center">
                        <div>
                    ...
                    <div class="col-md-2 d-flex justify-content-center">
                        ...
                        <p class="lead fw-normal mb-0">Rp. 70.000,00</p>
                        </div>
                    </div>
                    <div class="col-md-2 d-flex justify-content-center">
                        <div>
                ...
                <div class="card-body p-4">
                    ...
                    <p class="mb-0 me-5 d-flex align-items-center">
                        ...
                        class="lead fw-normal">Rp. 70.000,00</span>
                    </p>
                    </div>
                ...
                <a type="button" class="btn btn-light btn-lg me-2" href="/catalogwoman">Continue shopping</a>
