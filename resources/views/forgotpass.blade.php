            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center" style="background-color: #CDBBA7">
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form>
                  ...
                  <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Enter your email address</h5>
...
<!-- 
                  ...
                  <div class="form-outline mb-4">
                    <input type="notelp" id="form2Example17" class="form-control form-control-lg" />
                    <label class="form-label" for="form2Example17">Number Phone</label>
                  </div> -->

                  <div class="pt-1 mb-4">
                    <a class="btn btn-dark btn-lg btn-block" href="/confirmPassword" type="button">Sent</a>
                  </div>
                </form>
